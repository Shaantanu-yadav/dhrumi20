...
<body>
	...
	<nav class="navbar navbar-light navbar-expand-md fixed-top bg-light"
		style="font-weight: bold; border-bottom: 1px solid #0d6efd;">
		...
		<div class="col-md-8 offset-md-2">
			<form class="custom-form mt-5 mb-5 pt-0" action="/InsertData"
				...
				<div class="row form-group my-4 mx-4">
					<div class="col-sm-4 label-column">
						<label class="col-form-label" for="text" style="font-size: 14px;">Product
							Code*</label>
					</div>
					<div class="col-sm-6 input-column">
				...
				<div class="row form-group my-4 mx-4">
					...
					<div class="col-sm-6 col-xxl-7 input-column">
						<input class="form-control"  type="text" required
							style="padding-left: 11px; margin-right: -20px; padding-right: 0px"
				...
				<div class="row form-group my-4 ms-4">
					...
					<div class="col-sm-6 input-column">
						<input class="form-control" type="text"
							style="margin-left: -12px;" name="sap"
				...
				<div class="row form-group mx-3 ps-0 ms-4">
					...
					<div class="col-sm-4 input-column">
						<label class="switch"> <input type="checkbox"
							name="status" value="Active" checked> <span
				...
				<div class="row mx-4" style="margin-top: 30px; padding-left: 34px;">
					<div class="col-md-4 col-xxl-4">
						<button class="btn btn-light submit-button" type="button" id="btn"
							value="Submit" style="width: 150px; height: 42px;"
					...
					<div class="modal fade" id="AddDataModal" tabindex="-1"
						...
						<div class="modal-dialog">
							<div class="modal-content">
								...
								<div class="modal-body">Do you really want Add this data?</div>
								<div class="modal-footer">
									<button class="btn btn-light align-items-center" type="button"
										data-bs-dismiss="modal"
										style="padding-left: 29px; width: 600px; margin-right: 138px; margin-left: 141px;">Close</button>
									<button class="btn btn-primary" type="submit"
										style="margin-left: 140px; margin-right: 135px;">Save
									</button>
								</div>
							</div>
						</div>				
